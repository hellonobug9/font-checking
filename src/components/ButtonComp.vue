<template>
  ...
  <span class="absolute -start-full transition-all group-hover:start-4">
    ...
    >
      ...
      <span class="text-3xl font-medium transition-all group-hover:ms-4"> Download </span>
    </a>
  ...
  <span class="absolute -end-full transition-all group-hover:end-4">
    ...
    >
      ...
      <span class="text-3xl font-medium transition-all group-hover:me-4"> Download </span>
    </a>
